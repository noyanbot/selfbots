...
wait = {
    ...
    'timeline':False,
    'autoAdd':True,
    'message':""" 💥🔥[°>Ekledigin için teşekkürler<°】🔥💥
                              😎
                         🖕🏻👕👊🏻
                              👖
                              👢
          💥🔥O T O M A T I K 💥M E S A J 🔥💥

  👑•••••••A D M İ N •••••••👑
         https://line.me/R/ti/p/~xnoyanx
   💥🔥💥🔥💥🔥💥🔥💥🔥💥🔥💥
...
#                cl.sendMessage(msg)
                ...
                msg.contentType = 13
                msg.contentMetadata = {'mid': 'u63e31848688c16dbc50e7ef0d778510b'}
                cl.sendText(msg.to,"❂•••••••••🏆A D M I N🏆••••••••••❂")
                cl.sendMessage(msg)
                msg.contentType = 13
                msg.contentMetadata = {'mid': 'u5404e2a6d3c2c48b5a106c2d6b66a6ad'}
                cl.sendMessage(msg)
                cl.sendText(msg.to,"❂••••••••⭐ A D M I N ⭐••••••••❂")
...
#---------------------------------------------------
                ...
                if msg.toType == 2:
                    ...
                    cl.sendText(msg.to," Davet iptal edildi .")
#---------------------------------------------------
...
#-----------------------------------------------
                ...
                ginfo = cl.getGroup(msg.to)
                cl.sendText(msg.to,"selamun aleykum gurup  " + str(ginfo.name))
